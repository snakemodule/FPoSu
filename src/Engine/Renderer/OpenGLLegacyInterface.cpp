...
{
	m_color = color;
	glColor4f((float)((unsigned char)(m_color >> 16))  / 255.0f, (float)((unsigned char)(m_color >> 8)) / 255.0f, (float)((unsigned char)(m_color >> 0)) / 255.0f, (float)((unsigned char)(m_color >> 24)) / 255.0f);
}
