...
UString OsuMainMenu::MCOSU_MAIN_BUTTON_SUBTEXT = UString("Based on McOsu");
...
OsuMainMenu::OsuMainMenu(Osu *osu) : OsuScreen(osu)
{
	...
	versionString.append(" by McKay. FPoSu Version 0.9 by SnakeModule");
...
{
	env->openURLInDefaultBrowser("https://github.com/snakemodule/FPoSu");
}
